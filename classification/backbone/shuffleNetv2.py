...
def shufflenetv2(width_mult=1., pretrained = False, num_classes = 7):
    model = ShuffleNetV2(width_mult=width_mult, n_class=num_classes)
    if pretrained:
...
if __name__ == "__main__":
    """Testing
    """
    model = shufflenetv2(pretrained=False, num_classes=7)
