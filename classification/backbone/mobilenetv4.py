...
class MobileNetV4(nn.Module):
    def __init__(self, model, num_classes = 1000):
        ...
        self.conv0 = build_blocks(self.spec['conv0'])     # [1, 32, 112, 112]
        self.layer1 = build_blocks(self.spec['layer1'])   # [1, 32, 56, 56]
        self.layer2 = build_blocks(self.spec['layer2'])   # [1, 64, 28, 28]
        self.layer3 = build_blocks(self.spec['layer3'])   # [1, 96, 14, 14]
        self.layer4 = build_blocks(self.spec['layer4'])   # [1, 128, 7, 7]
        self.layer5 = build_blocks(self.spec['layer5'])   # [1, 1280, 7, 7]
